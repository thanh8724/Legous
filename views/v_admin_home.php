                ...
                <div id="statisticalChart" class="statisticalChart p30">
                    <div class="statisticalChartItems">
                        <div class="col-12 d-xxl-flex customerOrderStatistics d-md-block d-sm-block">
                                        ...
                                        <ul class="nav nav-tabs myNavTabs" id="myTab" role="tablist">
                                            <li class="nav-item myNavItem" role="presentation" style="width: 50%;">
                                                <button style="width: 100%;" class="nav-link active" id="statistical"
                                                    data-bs-toggle="tab" data-bs-target="#statistical-date"
                                                    type="button" role="tab" aria-controls="statistical-date"
                                                    aria-selected="true">Theo
                                                    Ngày</button>
                                            </li>
                                            <li class="nav-item myNavItem" role="presentation" style="width: 50%;">
                                                <button style="width: 100%;" class="nav-link" id="statistical"
                                                    data-bs-toggle="tab" data-bs-target="#statistical-month"
                                                    type="button" role="tab" aria-controls="statistical-month"
                                                    aria-selected="false">Theo
                                                    Tháng</button>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-xxl-5 col-lg-12 col-md-12 col-sm-12 p20 box-shadow3 topUsers mt-xxl-0 mt-md-5 mt-sm-5 mt-5">
                                            ...
                                            <div class="ordertopProduct_item">
                                                <div class="col-12 d-flex justify-content-between">
                                                    <div class="col-6 nameCategories">
                                                        <h2 class="body-large">Sasuke - Susano toàn....</h2>
                                                        <p class="label-medium">Danh mục: <span>Naruto</span></p>
                                                    </div>
                                                    <div class="col-6 priceProduct">
                                                        <h2 class="body-large">12.389.000 VNĐ</h2>
                                                        <p class="label-medium">5 đã mua</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="ordertopProduct_item">
