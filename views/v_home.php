...
<section class="section benefit__section row flex-between g30">
    <div class="flex-column g12" style="max-width: min(40rem, 100%)">
        ...
        <div class="panels">
            ...
            <div class="panel__item">
                ...
                <div class="width-full collection__item mt30">
                    ...
                    <div class="product__wrapper product__wrapper--normal product__wrapper--normal--slick__2 mt30 auto-grid g20">
                        <div class="product product__carousel">
                            <a href="#" class="product__banner oh banner-cover rounded-8 por"
                                style="background-image: url('./public/assets/media/images/product/v944cyfrwt851.webp')">
                                <div class="product__overlay poa flex-center">
            ...
            <div class="panel__item">
                ...
                <div class="width-full collection__item mt30">
                    <!-- /*collection item title*/ -->
                    <div class="flex-between">
                        <h2 class="text-46 ttu">marvel & dc</h2>
                        <a href="#" class="btn rounded-100 text-btn"><i class="fal fa-arrow-right"></i>Xem nhiều
                            hơn</a>
                    </div>
                    <div
            ...
            <div class="panel__item">
                ...
                <div class="width-full collection__item mt30">
                    <!-- /*collection item title*/ -->
                    <div class="flex-between">
                        <h2 class="text-46 ttu">gundam</h2>
                        <a href="#" class="btn rounded-100 text-btn"><i class="fal fa-arrow-right"></i>Xem nhiều
                            hơn</a>
                    </div>
                    <div
            ...
            <div class="panel__item">
                ...
                <div class="width-full collection__item mt30">
                    <!-- /*collection item title*/ -->
                    <div class="flex-between">
                        <h2 class="text-46 ttu">kimestu no yaiba</h2>
                        <a href="#" class="btn rounded-100 text-btn"><i class="fal fa-arrow-right"></i>Xem nhiều
                            hơn</a>
                    </div>
                    <div
