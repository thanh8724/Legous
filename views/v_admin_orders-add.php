                ...
                <div class="row d-flex d-flex justify-content-between ">
                    <div style="width:49%;">
                        ...
                        <div class="row">
                            ...
                            <input style="padding:13px;" type="" name="name_us_order" class="form-control form-control-lg"  placeholder="">
                        </div>
                        <div class="row">
                            <label for="" class="col-sm-2 col-form-label col-form-label-lg">Địa Chỉ</label>
                            <input style="padding:13px;" type="" name="location_us_order" class="form-control form-control-lg"  placeholder="">
                        </div>
                        <div class="row">
                            <label for="" class="col-sm-2 col-form-label col-form-label-lg">Email</label>
                            <input style="padding:13px;" type="" name="email_us_order" class="form-control form-control-lg"  placeholder="">
                        </div>
                        <div class="row">
                            <label for="" class="col-sm-2 col-form-label col-form-label-lg">Điện Thoại</label>
                            <input style="padding:13px;" type="" name="phone_us_order" class="form-control form-control-lg"  placeholder="">
                        </div>
                    </div>
                    <div style="width:49%;">
                        ...
                        <div class="row">
                        <label style="width:300px !important;" for="" class="col-sm-2 col-form-label col-form-label-lg">Tổng Đơn</label>
                            <input style="padding:13px;" type="" name="total_order" class="form-control form-control-lg"  placeholder="">
                        </div>
                        <div class="row">
                            <label style="width:300px !important;"  for="" class="col-sm-2 col-form-label col-form-label-lg">Cách Thức Giao</label>
                            <select name="method_order" style="padding:13px;" class="form-select form-select-lg " aria-label=".form-select-lg example">
                        ...
                        <div class="row">
                            <label style="width:300px !important;"  for="" class="col-sm-2 col-form-label col-form-label-lg">Trang Thái Đơn</label>
                            <select name="status_order" style="padding:13px;" class="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
             ...
             <div style="background-color:rgba(128, 128, 128, 0.99);" class="modal fade" id="exampleModalToggle" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
                <div  class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-footer d-flex justify-content-between">
                        ...
                        <button style="padding:12px 20px;" type="button" class="btn btn-primary"><a style="color:white" href="?mod=admin&act=orders">Hủy Cập Nhật</a></button>
                    </div>
                    </div>
                </div>
            </div>
