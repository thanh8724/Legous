                ...
                <div class="content_banner_left col-8">
                  <div class="text_right_banner flex-column g30">
                    ...
                    <div class="text_bottom">
                      <p class="label-medium">Khám phá những mô hình thú vị và độc đáo cùng với LEGOUS! Tại đây, chúng tôi cung cấp những mô hình với đa dạng nhân vật và các chủ đề khác nhau, hứa hẹn sẽ đáp ứng được nhu cầu mua sắp của bạn.</p>
                    </div>
              ...
              <div id="banner" class="banner_admin d-inline-flex justify-content-between col-12" style="padding: 53px 100px;"> 
                <div class="content_banner_left col-8">
                  <div class="text_right_banner flex-column g30">
                    ...
                    <div class="text_bottom">
                      <p id="text-description" class="label-medium">Khám phá những mô hình thú vị và độc đáo cùng với LEGOUS! Tại đây, chúng tôi cung cấp những mô hình với đa dạng nhân vật và các chủ đề khác nhau, hứa hẹn sẽ đáp ứng được nhu cầu mua sắp của bạn.</p>
                    </div>
                  <div class="content_btn_banner_admin d-flex col-12">
                      <div class="btn-banner_left align-items-center d-flex col-4">
                        <button class="d-inline-flex box-shadow1"><span class="label-large">Mua ngay</span></button>
