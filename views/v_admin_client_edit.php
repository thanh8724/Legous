            ...
            <div class="sliderDashboard_order-add-create sliderDashboard_order-detail rounded-4">
                <div class="body_sliderDashboard_order-add-create p20 row">
                    <div class="col-7">
                        ...
                        <div class="left-order-add-create">
                            <h2>Địa Chỉ</h2>
                            <input name="address" class="" type="text" value="<?php echo $userInfo[0]['address'] ?>" placeholder="Nhập Địa chỉ" aria-label="default input example">
                        </div>
                        <div class="describe-order_detail">
                            <h2>Mô Tả</h2>
                            <textarea name="bio" id="" cols="30" rows="10" placeholder="Nhập mô tả người dùng" value="<?php echo $userInfo[0]['bio'] ?>"><?php echo $userInfo[0]['bio'] ?></textarea>
                        </div>
