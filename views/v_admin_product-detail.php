                ...
                <div class="body_sliderDashboard_order-add-create p20 row">
                    <div class="col-7">
                        ...
                        <div class="Dropdowns_categogy">
                            ...
                            <div class="custom-select">
                                ...
                                <select id="dropdown" onchange="updateInput()" name="id_category">
                                    <option value="1" <?=($productdetail['id_category'] == 1)?'selected':''?>>Ninja Go
                                    </option>
                                    <option value="2" <?=($productdetail['id_category'] == 2)?'selected':''?>>Naruto
                                    </option>
                                    <option value="3" <?=($productdetail['id_category'] == 3)?'selected':''?>>dragon
                                        ball</option>
                                    <option value="4" <?=($productdetail['id_category'] == 4)?'selected':''?>>Marvel &
                                        DC</option>
                                    <option value="5" <?=($productdetail['id_category'] == 5)?'selected':''?>>One Piece
                                    </option>
                                    <option value="6" <?=($productdetail['id_category'] == 6)?'selected':''?>>Car
                                    </option>
                                    <option value="7" <?=($productdetail['id_category'] == 7)?'selected':''?>>Gundam
                                    </option>
                                    <option value="8" <?=($productdetail['id_category'] == 8)?'selected':''?>>Kimetsu no
                                        Yaiba</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <h2>Giá</h2>
                                <input class="" name="price" type="text"
                                    placeholder="<?=number_format($productdetail['price'])?> VNĐ"
                                    aria-label="default input example">
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row">
                            <div class="rol-6 mt-3">
                                <input style="color: #fff ;padding: 10px 15px; font-size: 14px; font-weight: 500;"
                                    class="btn btn-primary" type="submit" name="submit" value="Sửa Sản Phẩm">
                            </div>
                        </div>
                    </div>
