<section class="dashboard">
    ...
    <div class="containerAdmin">
        ...
        <div class="flex-center m-5">
            <span class="body-medium" style="font-size: 18px;">Kết quả tìm kiếm: <span class="label-large-prominent"
                    style="font-size: 20px;"><?=$_GET['kw']?></span></span>
            </span>
        </div>
                    ...
                    <div class="h-nav g12" style="justify-content: space-between;">
                        <div class="img-cart flex" style="width: 120px; flex-shrink: 1;">
                            <img src="./public/assets/media/images/product/<?= $item['img'] ?>"
                                style="max-width: 100%; height: 100px;object-fit: cover; border-radius: 8px; flex-shrink: 0;"
                                alt="">
                        </div>
        ...
        <ul id="paging" class="pagination flex g16 mt30">
            ...
            <li class="pagination__item">
                <a href="?mod=admin&act=products-search&page=<?= $page - 1 ?>&kw=<?= $keyword ?>"
            ...
            <li class="pagination__item <?= ($page == $i) ? 'active' : '' ?>">
                <a href="?mod=admin&act=products-search&page=<?= $i ?>&kw=<?= $keyword ?>"
                    class="btn body-small pagination__link"><?= $i ?></a>
            </li>
            <?php endfor; ?>
